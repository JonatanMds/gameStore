...
export default function GamePage(){
  ...
  const [listGames, setListGames] = useState<IGameInfos[]>([])
          ...
          return(
            <div key={gameInfo.id}>
              <div className="w-full md:relative">
                ...
                <section className="w-full flex flex-col md:flex-row md:absolute bottom-[-36px] px-6 pt-6 gap-6 bg-gradient-to-t from-base-black-300 from-20%">
                  <Image 
                    alt=""
                    src={gameInfo.urlCardBgImage}
                    width={400}
                    height={400}
                    style={{height:"250px", width:"100vw", objectFit:"cover", borderRadius:"4%"}}
                    className="md:hidden"
                  />
                  <Image 
                    alt=""
                  ...
                  />
                  <div className="flex flex-col justify-between md:w-[40%] gap-4 md:gap-0">
                  ...
                  <div className="md:w-[40%] flex flex-col justify-between">
                    ...
                    <div className="flex gap-4">
                      ...
                      {/* <PiShoppingCart className="rounded bg-base-purple-300 p-2" size={36}/> */}
                    </div>
                  </div>
                </section>
              </div>
